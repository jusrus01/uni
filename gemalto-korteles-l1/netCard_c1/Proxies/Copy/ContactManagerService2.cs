...
{
    public class ContactManagerService2
    {
        ...
        {
            return PubStorage2.ReadLinesFromLinePosition(ContactsFileName, from);
        }
        ...
        public bool RemoveContact(string name)
        {
            ...
            return PubStorage2.RemoveLineStartsWith(ContactsFileName, name + Separator);
        }
        ...
        private static void ForEachContact(ProcessContact processDelegate)
        {
            ...
            do
            {
                var readContactsChunck = PubStorage2.ReadLinesFromLinePosition(ContactsFileName, from);
